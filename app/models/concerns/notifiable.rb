module Notifiable
  ...
  def send_slack_notifications    
    Slack.chat_postMessage(text: "New #{self.class.name.underscore.humanize.downcase} by #{user_name}. #{url_helpers.send notifiable.class.name.underscore.humanize.downcase+'_url', notifiable.id}", 
