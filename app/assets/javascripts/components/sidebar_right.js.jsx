let SidebarRight = React.createClass({
  ...
  render(){
    return(
      <div className="sidebar_container sidebar_container_right" data-spy="affix" data-offset-bottom="40">
        <ul className="nav nav-pills nav-stacked left-menu sidebar sidebar-right">
